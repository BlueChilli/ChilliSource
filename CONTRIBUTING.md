...
Your contributions to ChilliSource are very welcome. Please grab and fix bugs and feature requests from the list of issues in our repositories.
...
* ensure that you have adequately commented your code, see [Comments](doc/comments.md)
